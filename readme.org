...
I keep improving on this guide. At first, I provided a raw XHTML version that was identical to the one you will find on my personal website. In September 2023, I switched to Org-Mode. I provide the org file and the XHTML export from Org which I have slightly edited to fit into my personal website.

This guide is published under the LaTeX project public license (LPPL), version 1.3c.
